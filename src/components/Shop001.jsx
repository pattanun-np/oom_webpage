...
export default class Shop001 extends Component {
    ...
    onChange1(event) {
        this.setState({QuatityS: event.target.value});
    }

    onChange2(event) {
        this.setState({QuatityM: event.target.value});
    }
    onChange3(event) {
        this.setState({QuatityL: event.target.value});
    }
    onChange4(event) {
        this.setState({QuatityXL: event.target.value});
    }
    onChange5(event) {
        this.setState({Quatity2XL: event.target.value});
    }
    onChangeEmail(event) {
    ...
    onChangeExternalComment(event) {
        this.setState({ExternalComment: event.target.value});
    }
            ...
            <div>
                ...
                <Animated animationIn="bounceInDown" animationOut="fadeOut" isVisible={true}>
                    ...
                    <Card id="container7">
                        ...
                        <Form>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridEmail">
                                    ...
                                    <Form.Control
                                        type="email"
                                        placeholder="กรอก email สำหรับยืนยันคำสั่งซื้อ"
                                        onChange={this
                                        .onChangeEmail
                                        .bind(this)}/>
                                </Form.Group>
                            ...
                            <Form.Group controlId="formGridAddress1">
                                ...
                                <Form.Control
                                    placeholder="ตัวอย่าง1234 Main St"
                                    onChange={this
                                    .onChangeAdress
                                    .bind(this)}/>
                            </Form.Group>
                        ...
                        <ListGroup>
                            <ListGroup.Item>
                                <h3 className="text">ไซส์ (S) จำนวน :
                                    <span>{this.state.QuatityS}
                                    </span>
                                    ตัว</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h3 className="text">ไซส์ (M) จำนวน :
                                    <span>{this.state.QuatityM}
                                    </span>
                                    ตัว</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h3 className="text">ไซส์ (L) จำนวน:
                                    <span>{this.state.QuatityL}
                                    </span>
                                    ตัว</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h3 className="text">ไซส์ (XL) จำนวน:
                                    <span>{this.state.QuatityXL}
                                    </span>
                                    ตัว</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h3 className="text">ไซส์ (2XL) จำนวน 2XL:
                                    <span>{this.state.Quatity2XL}
                                    </span>
                                    ตัว</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h3 className="text">ค่าสินค้า
                                    <span>
                                        {Total}</span>
                                    บาท</h3>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h4 className="text">+ ค่าจัดส่ง
                                    <span>{ShippingFee}</span>
                                    บาท</h4>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <h1 className="text">เป็นเงิน:
                                    <span>{SubTotal}</span>
                                    บาท</h1>
                            </ListGroup.Item>
                        </ListGroup>
                        ...
                        <Modal show={this.state.show} onHide={this.handleClose}>
                            ...
                            <Modal.Body>กรุณาตรวจสอบข้อมูลให้ครับถ้วนก่อนกดยืนยัน
                                <Card>
                                    ...
                                    <h2 className="text4">รวมเป็นเงิน:
                                        <span>{SubTotal}
                                        </span>
                                        บาท</h2>
